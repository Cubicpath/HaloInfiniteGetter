...
class SettingsWindow(Singleton, QWidget):
    ...
    def refresh_dropdowns(self) -> None:
        ...
        self.icon_mode_dropdown.setCurrentIndex(settings['gui/cache_explorer/icon_mode'])               # type: ignore
        self.aspect_ratio_dropdown.setCurrentIndex(settings['gui/media_output/aspect_ratio_mode'])      # type: ignore
        self.transformation_dropdown.setCurrentIndex(settings['gui/media_output/transformation_mode'])  # type: ignore
        self.line_wrap_dropdown.setCurrentIndex(settings['gui/text_output/line_wrap_mode'])             # type: ignore
